 ...
 * Full-motion universe. Un geste, une preuve.
 */
...
// Orbes flottants en fond — 8 particules qui derivent lentement
        ...
        <AnimatePresence mode="wait">
          {phase === 'idle' && (
            ...
            >
              ...
              <motion.p variants={item} className="text-base md:text-lg text-slate-600 mb-16 font-light tracking-wide">
